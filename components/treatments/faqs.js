                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-gray-200">
                                            <th className="p-4 font-semibold text-gray-800">BMI</th>
                                            <th className="p-4 font-semibold text-gray-800">Weight status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr className="bg-gray-100">
                                            <td className="p-4">Below 18.5</td>
                                            <td className="p-4">You are in the underweight range</td>
                                        </tr>
                                        <tr className="bg-white">
                                            <td className="p-4">18.5 – 24.9</td>
                                            <td className="p-4">You are in the healthy range</td>
                                        </tr>
                                        <tr className="bg-gray-100">
                                            <td className="p-4">25.0 – 29.9</td>
                                            <td className="p-4">You are in the overweight range</td>
                                        </tr>
                                        <tr className="bg-white">
                                            <td className="p-4">30.0 and above</td>
                                            <td className="p-4">You are in the obese range</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
